...
支持创建和只读查看 Camera、MediaMTX Path 读写、运行态投影和后台媒体恢复；播放、列表、编辑和
删除仍在 [Cameras MVP 剩余计划](../../plans/cameras-mvp/README.md)中。
...
| 播放、列表、更新、删除                  | 未实现 | [剩余计划](../../plans/cameras-mvp/README.md) |
