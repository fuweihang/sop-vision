...
- `backend/README.md`
- `docs/plan/cameras-mvp/01-foundation/README.md`
...
- 普通成功、Problem 4xx、5xx、CORS OPTIONS、流式响应和未处理异常。
...
- access log 包含 method、path、status、duration 和有效 trace。
