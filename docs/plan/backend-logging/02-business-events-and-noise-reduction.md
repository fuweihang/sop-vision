...
- `docs/plan/cameras-mvp/03-stream-gateway-adapter/README.md`
- `docs/plan/cameras-mvp/04-media-reconciliation/README.md`
- `docs/plan/cameras-mvp/05-camera-create/README.md`
