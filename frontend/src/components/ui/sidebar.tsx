...
function SidebarProvider({
  ...
  // 这是 Sidebar 的内部状态。
  // 通过 openProp 和 setOpenProp 从组件外部控制状态。
  ...
  // 提供 state，以便设置 data-state="expanded" 或 "collapsed"。
  // 这样可以更方便地通过 Tailwind 类设置 Sidebar 样式。
